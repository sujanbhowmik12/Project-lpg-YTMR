      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
        ...
        <div className="mb-5">
          <button
            ...
            className="w-full py-3.5 bg-slate-950 hover:bg-slate-800/90 text-slate-100 font-bold rounded-2xl border border-slate-700 hover:border-brand-500/60 transition-all flex items-center justify-center gap-3 text-xs shadow-xl group"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-gradient-to-r from-brand-500 to-orange-600 hover:from-brand-600 hover:to-orange-700 text-white font-bold rounded-xl shadow-lg shadow-brand-500/25 transition-all flex items-center justify-center gap-2 text-xs mt-3"
          >
