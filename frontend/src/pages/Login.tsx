      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-4 py-2.5 text-slate-100 uppercase focus:border-brand-500 focus:outline-none"
                />
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-4 py-2.5 text-slate-100 focus:border-brand-500 focus:outline-none"
                />
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-10 py-2.5 text-slate-100 focus:border-brand-500 focus:outline-none transition-all"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-brand-500 to-orange-600 hover:from-brand-600 hover:to-orange-700 text-white font-bold rounded-xl shadow-lg shadow-brand-500/25 transition-all flex items-center justify-center gap-2 text-xs mt-4 cursor-pointer"
          >
        ...
        <div className="mt-5 p-3.5 bg-slate-950/80 rounded-xl border border-slate-800 text-[11px] text-slate-400 space-y-2">
          ...
          <button
            ...
            className="w-full py-2 bg-slate-900 hover:bg-slate-800 text-brand-400 font-semibold rounded-lg border border-slate-800 text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
          >
